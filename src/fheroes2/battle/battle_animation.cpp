    ...
    : _monsterID( monsterID )
{
    ...
    if ( monsterID < Monster::PEASANT || ( monsterID > Monster::WATER_ELEMENT && monsterID != Monster::AZURE_DRAGON && monsterID != Monster::BLOOD_DRAGON && monsterID != Monster::THOR && monsterID != Monster::AVENGER && monsterID != Monster::SUCCUBUS && monsterID != Monster::DACHSHUND && monsterID != Monster::MAID ) ) {
        return;
    }
