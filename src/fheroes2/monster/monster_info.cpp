...
namespace
{
    ...
    void populateMonsterData()
    {
        ...
        monsterData[Monster::DACHSHUND].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::NO_ENEMY_RETALIATION );
        ...
        monsterData[Monster::AZURE_DRAGON].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::MORAL_DECREMENT, 100, 1 );
...
namespace fheroes2
{
    ...
    std::string getMonsterAbilityDescription( const MonsterAbility & ability, const bool ignoreBasicAbilities )
    {
        ...
        case MonsterAbilityType::HP_REGENERATION:
            if ( ability.value > 0 ) {
                std::string str = _( "Regenerates %{hp} HP per turn" );
                StringReplace( str, "%{hp}", ability.value );
                return str;
            }
