...
namespace
{
    ...
    double getMonsterBaseStrength( const fheroes2::MonsterData & data )
    {
        ...
        if ( const auto abilityIter = std::find( abilities.begin(), abilities.end(), fheroes2::MonsterAbilityType::SPELL_CASTER ); abilityIter != abilities.end() ) {
            ...
            case Spell::CHAINLIGHTNING:
                // Lightning spells deal significant damage.
                monsterSpecial += abilityIter->percentage / 100.0 * 0.8;
                break;
            default:
    ...
    void populateMonsterData()
    {
        ...
        const fheroes2::MonsterBattleStats monsterBattleStats[Monster::MONSTER_COUNT] = {
            ...
            { 17, 17, 25, 35, 350, Speed::ULTRAFAST, 24, 0, {}, {} }, // Thor
        ...
        const fheroes2::MonsterGeneralStats monsterGeneralStats[Monster::MONSTER_COUNT]
            = { // name | plural name | growth | race | level | cost
                ...
                { gettext_noop( "Azure Dragon" ), gettext_noop( "Azure Dragons" ), 1, Race::WRLK, 6, { 5000, 0, 0, 0, 3, 0, 0 } },
        ...
        monsterData[Monster::AZURE_DRAGON].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::DRAGON );
        monsterData[Monster::AZURE_DRAGON].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::DOUBLE_HEX_SIZE );
        ...
        monsterData[Monster::BLOOD_DRAGON].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::DRAGON );
        monsterData[Monster::BLOOD_DRAGON].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::DOUBLE_HEX_SIZE );
        monsterData[Monster::BLOOD_DRAGON].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::FLYING );
        monsterData[Monster::BLOOD_DRAGON].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::UNDEAD );
        monsterData[Monster::BLOOD_DRAGON].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::MORAL_DECREMENT, 100, 1 );
        // Life drain attack - drains life from enemies
        monsterData[Monster::BLOOD_DRAGON].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::HP_DRAIN );
        ...
        monsterData[Monster::THOR].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::IMMUNE_TO_CERTAIN_SPELL, 100, Spell::LIGHTNINGBOLT );
        monsterData[Monster::THOR].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::IMMUNE_TO_CERTAIN_SPELL, 100, Spell::CHAINLIGHTNING );
        // Chain Lightning caster - always casts on attack, bounces to nearby enemies
        monsterData[Monster::THOR].battleStats.abilities.emplace_back( fheroes2::MonsterAbilityType::SPELL_CASTER, 100, Spell::CHAINLIGHTNING );
