...
#include "composite_dxil_embedded.h" // generated by CMake from src/engine/shaders/*.dxil
...
namespace
{
    ...
    protected:
        ...
        bool allocate( fheroes2::ResolutionInfo & resolutionInfo, bool isFullScreen ) override
        {
            ...
            // Phase 2 ships DXIL only, so request just SPIRV/DXIL — pass both flags
            // so SDL_GPU can pick the supported backend (D3D12 on Windows, Vulkan
            // would need SPIRV which we don't ship yet). On Windows D3D12 is
            // preferred and will pick DXIL.
            const SDL_GPUShaderFormat shaderFormats = SDL_GPU_SHADERFORMAT_DXIL;
    ...
    private:
        ...
        bool _createPipelines()
        {
            ...
            vsInfo.code = fheroes2::shaders::composite_vert_dxil;
            vsInfo.code_size = fheroes2::shaders::composite_vert_dxil_size;
            ...
            fsCompositeInfo.code = fheroes2::shaders::composite_frag_dxil;
            fsCompositeInfo.code_size = fheroes2::shaders::composite_frag_dxil_size;
            fsCompositeInfo.entrypoint = "main";
            fsCompositeInfo.format = SDL_GPU_SHADERFORMAT_DXIL;
            ...
            fsCursorInfo.code = fheroes2::shaders::cursor_frag_dxil;
            fsCursorInfo.code_size = fheroes2::shaders::cursor_frag_dxil_size;
            fsCursorInfo.entrypoint = "main";
            fsCursorInfo.format = SDL_GPU_SHADERFORMAT_DXIL;
